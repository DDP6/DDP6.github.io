...
function displayPerson(event) {
	...
	var html = "<p>Your Info: " + personM.month + " " + personD.day +", " + personY.year + ".</p> <hr> <p>You're probably wondering where the secret info is right??? PSYCH THERE ISN'T ANY LULZ and the 'CLICK?' does nothing</p>"
